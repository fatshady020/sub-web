...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "自用": "https://now-subconverter-beta.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://now-subconverter-beta.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://now-subconverter-beta.vercel.app/sub?";
